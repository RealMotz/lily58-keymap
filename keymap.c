...
/* _LAYER2
 * ,-------------------------------------------------------------.                      ,------------------------------------------------------.
 * | ESC  |open_con|ctrl+u|emmet(alt+m)|  ctrl+g    |ctrl+Shift+p|                      |ctrl+/ |       |    alt+;  | alt+' |Shift+Alt+F| <--  |
 * |------+--------+------+------------+------------+------------|                      |-------+-------+-----------+-------+-----------+------|
 * | Tab  |        |      |brow_sel_el |  sel_all   |  ctrl+alt  |                      |  Home |   Up  |    End    |       |  del ws   |  Del |
 * |------+--------+------+------------+------------+------------|                      |-------+-------+-----------+-------+-----------+------|
 * | Ctrl |        |      |            |   ctrl+\   |  Shift+Alt |---------.  ,---------| Left  | Down  |   Right   |       |  collapse |alt+q |
 * |------+--------+------+------------+------------+------------|    ,    |  |    .    |-------+-------+-----------+-------+-----------+------|
 * |Shift |        |      |            |ctrl+shift+c| ctrl+shift |---------|  |---------|ctrl+[ |ctrl+] |Shift+Alt+L|       |   ctrl+.  |ctrl+`|
 * `-------------------------------------------------------------/       /     \         \-----------------------------------------------------'
 *                                      |  Alt | Ctrl |LAYER1 | / Space /       \ Enter   \  | LAYER2 |LAYER4 |LAYER3 T |
 *                                      |      |      |       |/       /         \         \ |        |       |         |
 *                                      `-----------------------------'           '--------' '--------------------------'
...
[_LAYER2] = LAYOUT(
  _______, RCS(KC_C), LCTL(KC_U), LALT(KC_M),LCTL(KC_G),    RCS(KC_P),                    LCTL(KC_SLASH), ARROW,        LALT(KC_SCLN), LALT(KC_QUOTE), LSA(KC_F),  _______,
  _______, XXXXXXX,   XXXXXXX,    RCS(KC_I),  RCS(KC_L),      LCA_T(KC_NO),                 KC_HOME,        KC_UP,         KC_END,        XXXXXXX,     NOWHITE,      _______,
  _______, XXXXXXX,   XXXXXXX,    XXXXXXX,   LCTL(KC_BSLS), LSA(KC_NO),                   KC_LEFT,        KC_DOWN,       KC_RGHT,       XXXXXXX,     COLLAPSE,     LALT(KC_Q),
 ...
 */
  [_LAYER4] = LAYOUT(
  XXXXXXX, ARROW3,  ARROW,   ARROW2, XXXXXXX, XXXXXXX,                 ARROW, ARROW2, ARROW3, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK,                 KC_QUES, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_AMPR, KC_DOLLAR,               _______, KC_AT, _______, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_0, _______,   _______,_______, KC_PERC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             _______, _______, _______, _______, _______,  _______, _______, _______
  )
  ,
/* _LAYER5
